...
#include <cctype>
#include <vector>
#include <windows.h>  // For Windows console enhancements
...
public:
    ...
    void displayAdditionalInfo() {
        ...
        cout << "----------------------------\n";
        cout << "Md Anis Mondal: Coding, Video Explanation of the project, PowerPoint Presentation, and Report\n";
        cout << "Md Reag Rahaman: PowerPoint Presentation and Report\n";
        cout << "Harsh: PowerPoint Presentation\n";
        cout << "Arpan Das: Report\n";
        cout << "----------------------------\n";
